...
//          Moonlight Overseas is your trusted partner for unforgettable travel  experiences, <br />  
//           We specialize in <span className="font-semibold">Visa Services, Manpower Recruitment, Document Attestation, Hajj and Umrah Packages, Air Ticketing,Customised Holiday Packages </span>
//           and <br /> Travel solutions for domestic and international destinations.
//         </p>
//       </div>
...
//         {/* Mission */}
//         <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
//           <h3 className="text-xl font-semibold mb-3 text-indigo-600">Our Mission</h3>
//           <p className="text-gray-600 text-sm sm:text-base">
//             To make every journey memorable, seamless, and hassle-free by offering <span className="font-medium">high-quality services, competitive pricing, and personalized travel experiences</span>.
//           </p>
//         </div>

//         {/* Services */}
//         <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
//           <h3 className="text-xl font-semibold mb-3 text-indigo-600">What We Offer</h3>
//           <ul className="text-gray-600 list-disc list-inside text-sm sm:text-base space-y-1">
//             <li>Holiday Tour Packages for India & Abroad</li>
//             <li>Domestic & International Air Ticket Booking</li>
//             <li>Document Attestation & Travel Support</li>
...
//         {/* Why Choose Us */}
//         <div className="bg-white rounded-xl shadow-md p-6 hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
//           <h3 className="text-xl font-semibold mb-3 text-indigo-600">Why Choose Us</h3>
//           <ul className="text-gray-600 list-disc list-inside text-sm sm:text-base space-y-1">
...
//       {/* Footer text */}
//       <p className="mt-12 text-center text-gray-700 max-w-2xl mx-auto text-sm sm:text-base px-4">
//         At Moonlight Overseas, we believe travel is not just about reaching a destination <br />it’s about creating memories that last a lifetime. 
//         Let us guide you to your dream vacation with professionalism, care, and dedication.
//       </p>
//     </section>
//   );
// };
...
// const About = () => {
//   return (
//     <section className="sticky py-20 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
//       {/* Optional decorative blob or wave */}
//       <div className="absolute top-0 left-0 w-full h-32 bg-indigo-50 -z-10"></div>
...
//             Moonlight Overseas is your trusted partner for unforgettable travel experiences. We specialize in:
//           </p>
//           <div className="mt-6 inline-block bg-indigo-50 rounded-full px-4 py-2">
//             <span className="text-indigo-800 font-medium text-sm sm:text-base">
//               Visa Services • Manpower Recruitment • Document Attestation • Hajj & Umrah • Air Ticketing • Custom Holiday Packages
//             </span>
//           </div>
//         </div>
...
//           {/* Mission Card */}
//           <div className="group relative bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 hover:border-indigo-200">
//             <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-bl-2xl rounded-tr-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
...
//                 To make every journey memorable, seamless, and hassle-free by offering <span className="font-medium text-gray-800">high-quality services, competitive pricing, and personalized travel experiences</span>.
//               </p>
//             </div>
//           </div>
...
//           {/* Services Card */}
//           <div className="group relative bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 hover:border-indigo-200">
//             <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-purple-50 to-pink-50 rounded-bl-2xl rounded-tr-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
//             <div className="relative z-10">
...
//                 {[
//                   "Holiday Tour Packages for India & Abroad",
//                   "Domestic & International Air Ticket Booking",
//                   "Document Attestation & Travel Support",
...
//           {/* Why Choose Us Card */}
//           <div className="group relative bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 hover:border-indigo-200">
//             <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-pink-50 to-red-50 rounded-bl-2xl rounded-tr-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
//             <div className="relative z-10">
...
//             “Travel is not just about reaching a destination — it’s about creating memories that last a lifetime.”
//           </blockquote>
//           <p className="mt-6 text-gray-600 text-base sm:text-lg">
//             Let us guide you to your dream vacation with professionalism, care, and dedication.
//           </p>
//           <div className="mt-8 inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 cursor-pointer">
//             <span><Link to="/">Start Your Journey →</Link></span>
//           </div>
//         </div>
//       </div>
//     </section>
...
//   return (
//     <section className="relative py-24 bg-gradient-to-br from-slate-50 via-white to-blue-50 overflow-hidden mt-6">
...
//           <h2 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 leading-tight tracking-tight">
//             Crafting
...
//               { text: "Custom Packages", color: "from-rose-500 to-pink-500" }
//             ].map((service, index) => (
//               <span 
//                 key={index}
...
//           {/* Mission Card */}
//           <div className="group relative bg-white/80 backdrop-blur-sm p-8 rounded-3xl border border-gray-100 shadow-xl hover:shadow-2xl transition-all duration-500 hover:border-blue-200 hover:translate-y-[-10px]">
...
//                 Redefining travel experiences through innovation, integrity, and personalized care. We're committed to creating 
//                 seamless journeys that exceed expectations while maintaining sustainable practices and cultural sensitivity.
//               </p>
//             </div>
//             <div className="absolute bottom-0 left-0 right-0 h-1  bg-gradient-to-r from-blue-500 to-cyan-500 rounded-b-3xl transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
//           </div>

//           {/* Services Card */}
//           <div className="group relative bg-white/80 backdrop-blur-sm p-8 rounded-3xl border border-gray-100 shadow-xl hover:shadow-2xl transition-all duration-500 hover:border-indigo-200 hover:translate-y-[-10px]">
...
//                 {[
//                   "Custom holiday packages & luxury escapes",
//                   "Global visa processing & documentation",
//                   "Air ticketing with price match guarantee",
//                   "Corporate travel management",
//                   "Destination weddings & events",
//                   "24/7 travel support & concierge"
//                 ].map((item, i) => (
//                   <div key={i} className="flex items-center gap-3 group/item">
//                     <div className="w-2 h-2 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full"></div>
//                     <span className="text-gray-600 text-sm sm:text-base group-hover/item:text-gray-900 transition-colors">{item}</span>
//                   </div>
//                 ))}
//               </div>
//             </div>
//             <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-b-3xl transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
//           </div>

//           {/* Values Card */}
//           <div className="group relative bg-white/80 backdrop-blur-sm p-8 rounded-3xl border border-gray-100 shadow-xl hover:shadow-2xl transition-all duration-500 hover:border-emerald-200 hover:translate-y-[-10px]">
...
//           {[
//             { number: "15K+", label: "Happy Travelers", color: "text-blue-600" },
//             { number: "40+", label: "Countries Served", color: "text-indigo-600" },
//             { number: "98%", label: "Visa Success Rate", color: "text-emerald-600" },
//             { number: "24/7", label: "Support Available", color: "text-amber-600" }
//           ].map((stat, index) => (
